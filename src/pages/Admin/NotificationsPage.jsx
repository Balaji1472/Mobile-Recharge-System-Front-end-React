  ...
  return (
    <div className="nb-pagination">
      ...
      {pages.map((p) => (
        <button
          key={p}
          className={`nb-page-btn ${p === page ? 'nb-page-btn--active' : ''}`}
    ...
    <div className="nb-page">
      ...
      <div className="nb-card">
        <div className="nb-card-top">
          <div className="nb-card-heading">
            <i className="fa-solid fa-bell"></i>
            All Notifications
          </div>
          <button className="nb-refresh-btn" onClick={fetchNotifications}>
                ...
                <tbody>
                  {paginated.map((n, i) => (
                    <tr key={n.notificationId ?? i} className={!n.readStatus ? 'nb-row--unread' : ''}>
                      <td>
                        <span className="nb-user-chip">
                          <i className="fa-solid fa-user"></i> #{n.userId}
                        </span>
                      </td>
