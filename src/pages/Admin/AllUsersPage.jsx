...
function ViewUserModal({ user, onClose, onStatusChange }) {
      ...
      <div className="um-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="um-modal-body">
          ...
          <div className="um-detail-grid">
            ...
            <DetailRow icon="fa-venus-mars"   label="Gender"        value={user.gender ? user.gender.charAt(0) + user.gender.slice(1).toLowerCase() : '—'} />
...
export default function AllUsersPage({ sidebarOpen, onSidebarClose }) {
  ...
  /* inline block/unblock from table */
        ...
        <div className="um-card">
          ...
          <div className="um-card-top">
            <div className="um-card-heading">
              ...
              <span>All Users</span>
              {!loading && <span className="um-count">( {filtered.length} )</span>}
            </div>
          </div>
