...
export default function CreateOfferPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const msg = err.response?.data?.message || 'Failed to create offer. Please try again.';
      showToast(msg, 'error');
    } finally {
      setSubmitting(false);
    }
    ...
    <div>
      <div className="co-page">
        ...
        <div className="co-card">
          ...
          {/* Form Grid — Row 1: Name | Discount Type | Discount Value */}
          <div className="co-form-grid">
            ...
            <div className="co-field">
              <label className="co-label">Discount Type</label>
              <select
                className="co-select"
            ...
            {/* Row 2: Start Date | End Date — each half width */}
