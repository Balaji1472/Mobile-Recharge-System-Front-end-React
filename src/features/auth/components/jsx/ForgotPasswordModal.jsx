...
import { forgotPasswordRequest, resetPasswordVerify } from '../../slice/authSlice';
import '../css/Auth.css';
...
export default function ForgotPasswordModal({ onClose }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      setTimer((t) => {
        if (t <= 1) { setExpired(true); clearInterval(id); return 0; }
        return t - 1;
      });
    }, 1000);
        ...
        <div className="fp-modal-body">
          ...
          {step === 1 && (
            <form onSubmit={handleSendOtp} noValidate>
              <p className="fp-desc">
                We'll send a 6-digit OTP to your email. It's valid for <strong>5 minutes</strong>.
              </p>
          ...
          {step === 2 && (
            <form onSubmit={handleReset} noValidate>
              ...
              <button type="submit" className="fp-btn" disabled={loading || expired}>
                {loading
